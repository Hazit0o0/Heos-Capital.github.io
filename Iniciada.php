...
<head>
    ...
    <link rel="stylesheet" href="iniciada.css">
...
<nav class="nav2">
    <ul>
        <?php if (isset($_SESSION['nombreUsuario'])) { ?>
            <li><a href="configuracion.php"><i class='bx bx-cog'></i></a></li>
            <li><a href="logout.php"><i class='bx bx-log-out'></i></a></li>
            <li><a href="#"><span class="nombre-usuario"><?php echo $_SESSION['nombreUsuario']; ?></span></a></li>
        <?php } else { ?>
            <li><button class="btn-register" onclick="location.href='registrarse.php'">Registrarse</button></li>
            <li><button class="btn-login" onclick="location.href='login.php'">Inicia Sesión</button></li>
        <?php } ?>
    </ul>
</nav>
